...
def evaluation_create(talent_id: int):
    ...
    if request.method == "POST":
        data = {
            ...
            "business_value": (request.form.get("business_value") or "").strip("\n ").strip() or None,
            "social_analysis": (request.form.get("social_analysis") or "").strip("\n ").strip() or None,
            "team_fit_analysis": (request.form.get("team_fit_analysis") or "").strip("\n ").strip() or None,
            "signing_review": (request.form.get("signing_review") or "").strip("\n ").strip() or None,
            "investment_model": (request.form.get("investment_model") or "").strip("\n ").strip() or None,
            "executive_notes": (request.form.get("executive_notes") or "").strip("\n ").strip() or None,
